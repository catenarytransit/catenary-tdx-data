...
pub struct FirstLastTrip {
    service_day: FirstLastServiceDay,
...
#[derive(Debug, Serialize, Deserialize)]
#[serde(rename_all = "PascalCase")]
pub struct FirstLastServiceDay {
...
pub type RouteFares = Vec<RouteFare>; //top level
...
pub type ThsrFares = Vec<ThsrFare>; //top level
...
#[derive(Debug, Serialize, Deserialize)]
#[serde(rename_all = "PascalCase")]
pub struct V3Operators { //top level
    update_time: String,
    update_interval: i64,
    src_update_time: String,
...
#[derive(Debug, Serialize, Deserialize)]
#[serde(rename_all = "PascalCase")]
pub struct V3TraStations { //top level
    update_time: String,
    update_interval: i64,
    src_update_time: String,
    src_update_interval: i64,
...
#[derive(Debug, Serialize, Deserialize)]
#[serde(rename_all = "PascalCase")]
pub struct V3AfrStations {  //top level
    update_time: String,
    update_interval: i64,
    src_update_time: String,
    src_update_interval: i64,
...
#[derive(Debug, Serialize, Deserialize)]
#[serde(rename_all = "PascalCase")]
pub struct TraAlerts { //top level
    update_time: String,
    update_interval: i64,
    src_update_time: String,
    src_update_interval: i64,
...
#[derive(Debug, Serialize, Deserialize)]
#[serde(rename_all = "PascalCase")]
pub struct MetroAlerts { //top level
    update_time: String,
    update_interval: i64,
    src_update_time: String,
    src_update_interval: i64,
